...
const ContactUs = () => {
  return (
    ...
    >
      ...
      {/* Submit Button */}
      <div className="flex justify-end mt-2 mr-56">
      ...
      <div className="flex flex-col lg:flex-row gap-4 mt-6 ml-48">
        <a
          href="#"
          className="flex items-center bg-ijo shadow-lg text-white px-6 rounded-lg hover:bg-green-600"
        >
          <span className="mr-2">
        ...
        <a
          href="#"
          className="flex items-center bg-purple shadow-lg text-white py-2 px-6 rounded-lg hover:bg-purple-600"
        >
          <span className="mr-2">
