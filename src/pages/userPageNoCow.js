...
const UserPageNoCow = () => {
  return (
    <div className="flex">
      ...
      >
        <div className="flex-1 mx-80 px-12 py-10 space-y-8 mt-28 p-10 relative">
          {/* Avatar (Position Absolute) */}
          <div
            className="absolute left-1/2 -top-0 transform -translate-x-1/2 z-10 mt-1"
            style={{
              width: "160px",
              height: "160px",
            }}
